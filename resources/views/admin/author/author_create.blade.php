...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('author_create') }}</div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.authors.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <textarea id="password" type="text" class="form-control @error('text') is-invalid @enderror" name="text" autocomplete="new-password">
                                </textarea>
